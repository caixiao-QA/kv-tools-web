...
function _encodeBase(message, bb) {
  ...
  if ($data !== undefined) {
    ...
    _encodePayload($data, nested);

    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  } // optional int32 hotVersion = 4;


  var $hotVersion = message.hotVersion;

  if ($hotVersion !== undefined) {
    writeVarint32(bb, 32);
    writeVarint64(bb, intToLong($hotVersion));
  } // optional int32 coldVersion = 5;


  var $coldVersion = message.coldVersion;

  if ($coldVersion !== undefined) {
    writeVarint32(bb, 40);
    writeVarint64(bb, intToLong($coldVersion));
  ...
  if ($deviceType !== undefined) {
    writeVarint32(bb, 50);
    writeString(bb, $deviceType);
  }
}

function DecodeBase(binary) {
...
function _decodeBase(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 3:
        {
          ...
          message.data = _decodePayload(bb);
          bb.limit = limit;
          break;
        }
      // optional int32 hotVersion = 4;
      ...
      case 4:
        {
          message.hotVersion = readVarint32(bb);
          break;
        }
      // optional int32 coldVersion = 5;
      ...
      case 5:
        {
          message.coldVersion = readVarint32(bb);
          break;
        }
      // optional string deviceType = 6;
      ...
      case 6:
        {
          message.deviceType = readString(bb, readVarint32(bb));
          break;
        }
...
function writeString(bb, text) {
  ...
  var n = text.length;
  var byteCount = 0; // Write the byte count first
  ...
  var bytes = bb.bytes; // Then write the bytes
...
function writeByteBuffer(bb, buffer) {
  ...
  var from = bb.bytes;
  var to = buffer.bytes; // This for loop is much faster than subarray+set on V8
...
function readFloat(bb) {
  ...
  var bytes = bb.bytes; // Manual copying is much faster than subarray+set in V8
...
function writeVarint64(bb, value) {
  ...
  var part2 = value.high >>> 24; // ref: src/google/protobuf/io/coded_stream.cc
...
function readVarint32ZigZag(bb) {
  var value = readVarint32(bb); // ref: src/google/protobuf/wire_format_lite.h
...
function readVarint64ZigZag(bb) {
  var value = readVarint64(bb,
  /* unsigned */
  false);
  var low = value.low;
  var high = value.high;
  var flip = -(low & 1); // ref: src/google/protobuf/wire_format_lite.h
...
function writeVarint64ZigZag(bb, value) {
  var low = value.low;
  var high = value.high;
  var flip = high >> 31; // ref: src/google/protobuf/wire_format_lite.h
